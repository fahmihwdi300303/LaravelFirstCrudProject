...
@section('content')
<h1 class="page-header text-center">UTS ALIF LAKIPADADA</h1>
<div class="row">
    <div class="col-md-12 col-md-offset-1">
        <h2>Mahasiswas Table
            <button type="button" data-bs-toggle="modal" data-bs-target="#addnew" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Mahasiswa</button>
        </h2>
    </div>
</div>
<div class="row">
